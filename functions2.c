 ...
 * @flags:  Cto alculates active flags
 * @width: width
...
/**
 * print_non_printable - a f that Prints ascii codes
...
/**
 * print_reverse - a f that Prints reverse string.
 * @types: the  List of arguments
 * @buffer: the Buffer array to handle print
...
/**
 * print_rot13string - a f that Print a string in rot13.
 * @types:the  List of arguments
 * @buffer: the buffer array to handle print
 * @flags: to  Calculates active flags
 * @width:  width
